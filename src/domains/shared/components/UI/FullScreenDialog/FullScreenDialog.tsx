...
import messages from '@/domains/app/components/App/App.messages';
...
const TransitionUp = React.forwardRef<any, any>(({ children, ...props }, ref) => (
  <Slide direction="up" {...props} ref={ref}>{children}</Slide>
));

const TransitionFade = React.forwardRef<any, any>(({ children, ...props }, ref) => (
  <Fade {...props} ref={ref}>{children}</Fade>
));
