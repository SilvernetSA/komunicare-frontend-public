...
vi.mock('../saveProtectedBoardWorkflow', () => ({
...
import { handleApiUpdates } from '../handleApiUpdates';
...
describe('handleApiUpdates', () => {
  beforeEach(() => {
    ...
    mocks.nameFromKey.mockReturnValue(null);
  ...
  it('returns false when the board-tile communicator copy resolution aborts', async () => {
    ...
    expect(params.switchBoard).not.toHaveBeenCalled();
