...
import Tile from '../../TileEditor/components/TileEditorContent/TilePreview/Tile.component';

import EditGridButtons from '@/domains/board/components/BoardView/BoardSideButtonsContainer/BoardContent/EditGridButtons.component';
import EmptyBoard from '@/domains/board/components/BoardView/BoardSideButtonsContainer/BoardContent/EmptyBoard.component';
import FixedGrid from '@/domains/board/components/BoardView/BoardSideButtonsContainer/BoardContent/FixedGrid';
import Grid from '@/domains/board/components/BoardView/BoardSideButtonsContainer/BoardContent/Grid';
import { DISPLAY_SIZE_GRID_COLS } from '@/domains/settings/components/Settings/Display/Display.constants';
  ...
  return (
    <div
      ...
      className={classNames('Board__tiles', {
        ...
        // Reserve room for the floating rows selector (EditGridButtons) so it
        // never covers the last row's selection checkmarks (same condition
        // that renders the selector).
        'Board__tiles--grid-editing': isFixedBoard && isSelecting && !isSaving,
      })}
      style={{
        overflowY: 'auto',
        height: '100%',
