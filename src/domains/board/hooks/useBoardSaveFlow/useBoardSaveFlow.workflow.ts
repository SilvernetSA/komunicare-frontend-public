import { resolveProtectedBoardCommunicatorCopy } from './useBoardSaveFlow.copyOnWrite';

import { persistBoardAndSyncNavigation } from '@/domains/board/stores/boardsStore/persistBoardAndSyncNavigation';
