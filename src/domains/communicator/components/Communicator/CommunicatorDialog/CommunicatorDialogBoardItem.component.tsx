...
import SymbolSearch from '@/domains/board/components/Board/SymbolSearch/SymbolSearch';
...
const CommunicatorDialogBoardItem: React.FC<Props> = ({
  ...
  const owningCommunicator = allCommunicators.find(
    ...
    <div className="CommunicatorDialog__boards__item">
      ...
      <BoardImageDialog
        ...
        onImageChange={((image: any) =>
          setState((prev) => ({ ...prev, imageBoard: image as any }))) as any}
        onSymbolSearchClick={() =>
