...
import { buildLoginSuccessPatch } from './buildLoginSuccessPatch';
import { fetchLoggedUserLocationAction } from './fetchLoggedUserLocation';
import { fetchUnloggedUserLocationAction } from './fetchUnloggedUserLocation';
import { refreshUserDataAction } from './refreshUserData';
import { saveUserProfileAction } from './saveUserProfile';

import {
  DISPLAY_SIZE_STANDARD,
  LABEL_POSITION_BELOW,
} from '@/domains/settings/components/Display/Display.constants';
import { NAVIGATION_BUTTONS_STYLE_SIDES } from '@/domains/settings/components/Navigation/Navigation.constants';
import { DEFAULT_FONT_FAMILY } from '@/domains/shared/providers/ThemeProvider/ThemeProvider.constants';
...
interface LiveHelp {
  ...
  communicatorTour: {
    ...
    isPublicCommunicatorsEnabled: boolean;
...
const initialAppState: AppState = {
  ...
  liveHelp: {
    ...
    communicatorTour: {
      ...
      isPublicCommunicatorsEnabled: true,
