...
import ChangePassword from '@/domains/user/components/Account/ChangePassword/ChangePassword';
import OAuthLogin from '@/domains/user/components/Account/OAuthLogin/OAuthLogin';
import Analytics from '../Analytics/Analytics';
import AuthScreen, {
  RedirectIfLogged,
  PrivateRoute,
} from '@/domains/user/components/AuthScreen/AuthScreen.component';
import BoardContainer from '@/domains/board/components/Board/Board';
import NotFound from '../NotFound/NotFound';
import Notifications from '@/domains/notifications/components/Notifications/Notifications';
import PremiumRequiredModal from '@/domains/subscription/components/PremiumFeature/PremiumRequiredModal';
import TrialRemainingModal from '@/domains/subscription/components/PremiumFeature/TrialRemainingModal';
